<?php 
	...
	// Associative array: ############# Associative Array simply changes the default position elements, i.e 0,1,2,3,4 etc to whatever we want. Like change 0 position to "butter","cake" or anything. ##################
